...
namespace ptp {
    ...
    public:
        MotionValidatorOccupancyDense(const ompl::base::SpaceInformationPtr& si, ProbCollisionChecker* pcc, const double min_flight_corridor_radius)
                : ompl::base::MotionValidator(si), pcc_(pcc), min_flight_corridor_radius_(min_flight_corridor_radius) {
