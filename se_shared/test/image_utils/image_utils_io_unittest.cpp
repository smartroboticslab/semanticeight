...
TEST_F(DepthImageIO, PNGSave16Load16)
{
    // Save the image.
    const int save_ok =
        se::save_depth_png(depth_image_data_16_.get(), depth_image_res_, "/tmp/depth_16.png");
    EXPECT_EQ(save_ok, 0);
    ...
    const int load_ok =
        se::load_depth_png(&loaded_depth_16, loaded_depth_image_res, "/tmp/depth_16.png");
    EXPECT_EQ(load_ok, 0);
...
TEST_F(DepthImageIO, PNGSaveFLoad16)
{
    ...
    const int save_ok = se::save_depth_png(
        depth_image_data_f_.get(), depth_image_res_, "/tmp/depth_f.png", depth_scale_);
    EXPECT_EQ(save_ok, 0);
    ...
    Eigen::Vector2i loaded_depth_image_res(0, 0);
    const int load_ok =
        se::load_depth_png(&loaded_depth_16, loaded_depth_image_res, "/tmp/depth_f.png");
    EXPECT_EQ(load_ok, 0);
...
TEST_F(DepthImageIO, PNGSave16LoadF)
{
    ...
    const int load_ok = se::load_depth_png(
        &loaded_depth_f, loaded_depth_image_res, "/tmp/depth_16.png", depth_inverse_scale_);
    EXPECT_EQ(load_ok, 0);
...
TEST_F(DepthImageIO, PNGSaveFLoadF)
{
    ...
    Eigen::Vector2i loaded_depth_image_res(0, 0);
    const int load_ok = se::load_depth_png(
        &loaded_depth_f, loaded_depth_image_res, "/tmp/depth_f.png", depth_inverse_scale_);
    EXPECT_EQ(load_ok, 0);
...
TEST_F(DepthImageIO, PGMSave16Load16)
{
    // Save the image.
    const int save_ok =
        se::save_depth_pgm(depth_image_data_16_.get(), depth_image_res_, "/tmp/depth_16.pgm");
    EXPECT_EQ(save_ok, 0);
    ...
    Eigen::Vector2i loaded_depth_image_res(0, 0);
    const int load_ok =
        se::load_depth_pgm(&loaded_depth_16, loaded_depth_image_res, "/tmp/depth_16.pgm");
    EXPECT_EQ(load_ok, 0);
...
TEST_F(DepthImageIO, PGMSaveFLoad16)
{
    ...
    const int save_ok = se::save_depth_pgm(
        depth_image_data_f_.get(), depth_image_res_, "/tmp/depth_f.pgm", depth_scale_);
    EXPECT_EQ(save_ok, 0);
    ...
    Eigen::Vector2i loaded_depth_image_res(0, 0);
    const int load_ok =
        se::load_depth_pgm(&loaded_depth_16, loaded_depth_image_res, "/tmp/depth_f.pgm");
    EXPECT_EQ(load_ok, 0);
...
TEST_F(DepthImageIO, PGMSave16LoadF)
{
    ...
    const int load_ok = se::load_depth_pgm(
        &loaded_depth_f, loaded_depth_image_res, "/tmp/depth_16.pgm", depth_inverse_scale_);
    EXPECT_EQ(load_ok, 0);
...
TEST_F(DepthImageIO, PGMSaveFLoadF)
{
    ...
    Eigen::Vector2i loaded_depth_image_res(0, 0);
    const int load_ok = se::load_depth_pgm(
        &loaded_depth_f, loaded_depth_image_res, "/tmp/depth_f.pgm", depth_inverse_scale_);
    EXPECT_EQ(load_ok, 0);
