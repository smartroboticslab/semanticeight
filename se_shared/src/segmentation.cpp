...
namespace se {
  ...
  const std::vector<float> coco_class_res            {default_res,  default_res,  default_res,  default_res,  default_res,   default_res,  default_res,  default_res,  default_res,  default_res,  default_res,      default_res,     default_res,  default_res,      default_res,  default_res,  default_res,  default_res,  default_res,  default_res,  default_res,  default_res,  default_res,  default_res,  default_res,  default_res,  default_res,  default_res,  default_res,  default_res,  default_res,  default_res,  default_res,  default_res,    default_res,  default_res,     default_res,       default_res,   default_res,  default_res,      default_res,  default_res,   default_res,  default_res,  default_res,  default_res,  default_res,  default_res,  default_res,  default_res,  default_res,  default_res,  default_res,  default_res,  default_res,  default_res,  default_res,  default_res,  default_res,  default_res,     default_res,  default_res,     default_res,  default_res,  default_res,  default_res,  default_res,  default_res,  default_res,   default_res,  default_res,  default_res,  default_res,  default_res,     0.01f,   default_res,  default_res,  default_res,  default_res,   default_res,   default_res};
