...
namespace se {
  ...
  class BoundingVolume {
    public:
      ...
      virtual bool isVisible(const Eigen::Matrix4f& T_VC,
                             const PinholeCamera&   camera) const = 0;
  ...
  class BoundingSphere : public BoundingVolume {
    public:
      ...
      BoundingSphere(Eigen::Vector3f& center,
                     float            radius = 0.f);

      BoundingSphere(const Eigen::Vector3f& vertex_min,
       ...
       */
      void computeProjection(const PinholeCamera&   camera,
