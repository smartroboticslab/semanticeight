...
TEST_F(NodeTest, coordinates)
{
    ...
    expected_node_coord << 0, 16, 0, 16, 0, 16, 0, 16, 0, 0, 16, 16, 0, 0, 16, 16, 0, 0, 0, 0, 16,
        16, 16, 16;
...
{
    Eigen::Matrix<int, 3, 8> expected_node_coord;
    expected_node_coord << 8, 24, 8, 24, 8, 24, 8, 24, 8, 8, 24, 24, 8, 8, 24, 24, 8, 8, 8, 8, 24,
        24, 24, 24;
    const se::Node<TestVoxelT>* root = octree_->root();
    for (int child_idx = 0; child_idx < 8; ++child_idx) {
...
TEST_F(NodeTest, childCoord)
{
    ...
    expected_child_coord << 0, 16, 0, 16, 0, 16, 0, 16, 0, 0, 16, 16, 0, 0, 16, 16, 0, 0, 0, 0, 16,
        16, 16, 16;
    const se::Node<TestVoxelT>* root = octree_->root();
    for (int child_idx = 0; child_idx < 8; ++child_idx) {
...
{
    Eigen::Matrix<int, 3, 8> expected_child_coord;
    expected_child_coord << 8, 24, 8, 24, 8, 24, 8, 24, 8, 8, 24, 24, 8, 8, 24, 24, 8, 8, 8, 8, 24,
        24, 24, 24;
    const se::Node<TestVoxelT>* root = octree_->root();
    for (int child_idx = 0; child_idx < 8; ++child_idx) {
