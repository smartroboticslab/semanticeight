...
#define QT_MOC_LITERAL(idx, ofs, len)                        \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET( \
        len,                                                 \
        offsetof(qt_meta_stringdata_Viewer_t, stringdata) + ofs - idx * sizeof(QByteArrayData))
...
void Viewer::qt_static_metacall(QObject* _o, QMetaObject::Call _c, int _id, void** _a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 0:
            ...
            break;
        case 1:
            _t->mousePressEvent((*reinterpret_cast<QMouseEvent*(*)>(_a[1])));
            break;
        case 2:
            _t->contextMenuEvent((*reinterpret_cast<QContextMenuEvent*(*)>(_a[1])));
            break;
        case 3:
            _t->checkBoxChanged();
            break;
        case 4:
            _t->plotWaveSelectionChanged();
            break;
        default:;
        }
    }
...
const QMetaObject Viewer::staticMetaObject = {{&QWidget::staticMetaObject,
...
#define QT_MOC_LITERAL(idx, ofs, len)                        \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET( \
        len,                                                 \
        offsetof(qt_meta_stringdata_Viewers_t, stringdata) + ofs - idx * sizeof(QByteArrayData))
...
void Viewers::qt_static_metacall(QObject* _o, QMetaObject::Call _c, int _id, void** _a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0:
            _t->menuAction((*reinterpret_cast<QAction*(*)>(_a[1])));
            break;
        default:;
        }
    }
...
const QMetaObject Viewers::staticMetaObject = {{&QWidget::staticMetaObject,
                                                qt_meta_stringdata_Viewers.data,
                                                qt_meta_data_Viewers,
                                                qt_static_metacall,
                                                0,
                                                0}};
