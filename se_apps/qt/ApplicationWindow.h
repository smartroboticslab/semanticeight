...
enum BreakpointType { COND_BOOL, COND_FGREATER, COND_FLESS, COND_FEQUAL };
...
class ApplicationWindow : public QMainWindow {
    ...
    void
    addButtonChoices(const char* label, int min, int max, int* value, void (*callback)() = NULL);
    void addButtonChoices(const char* label,
    ...
    void addButtonChoices(const char* label,
                          ...
                          float* variable,
                          void (*callback)() = NULL);
    std::string fileOpenSelector(std::string title, std::string directory, std::string filter);
    std::string fileSaveSelector(std::string title, std::string directory, std::string filter);
    void errorBox(std::string message);
    void addCheckBox(const char* label, bool* value);
    void setIdleFunction(void (*_callback)());
    void setCameraFunction(bool* isOpen, CameraState (*_callback)(CameraState, std::string));
    void setDumpFunction(const char* label, void (*_callback)());
    void setBreakpoints(QString values);
    void addConditionalBreakpoint(QString label, BreakpointType type, int value);
    void addConditionalBreakpoint(QString label, BreakpointType type, double value);
...
class DebugWindow : public QDialog {
    ...
    void addLineEdit(const char* label, const char* value, const char* tooltip = NULL);
    private slots:
    void accept();
    void reject();
